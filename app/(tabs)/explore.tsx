  ...
  return (
    <ParallaxScrollView
      ...
      <Collapsible title="Custom fonts">
        <ThemedText>
          Open <ThemedText variant="defaultSemiBold">app/_layout.tsx</ThemedText> to see how to load{' '}
      ...
      <Collapsible title="Animations">
        <ThemedText>
          ...
          the powerful <ThemedText variant="defaultSemiBold">react-native-reanimated</ThemedText> library
